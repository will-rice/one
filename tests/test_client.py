...
def test_detect_openai_gpt() -> None:
...
def test_init_openai_model() -> None:
...
def test_init_anthropic_model() -> None:
...
def test_init_invalid_model() -> None:
...
def test_generate_openai(mock_provider_class: Mock) -> None:
...
def test_generate_anthropic(mock_provider_class: Mock) -> None:
...
@patch("one.client.OpenAIProvider")
def test_generate_with_custom_params(mock_provider_class: Mock) -> None:
...
@patch("one.client.OpenAIProvider")
def test_generate_structured_openai(mock_provider_class: Mock) -> None:
...
@patch("one.client.AnthropicProvider")
def test_generate_structured_anthropic(mock_provider_class: Mock) -> None:
...
@patch("one.client.OpenAIProvider")
def test_generate_structured_with_custom_params(mock_provider_class: Mock) -> None:
