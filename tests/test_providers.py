...
def test_openai_init_with_api_key(mock_openai: Mock) -> None:
...
@patch("one.providers.openai.OpenAI")
def test_openai_init_with_env_key(mock_openai: Mock) -> None:
...
@patch("one.providers.openai.OpenAI")
def test_openai_generate(mock_openai: Mock) -> None:
...
@patch("one.providers.openai.OpenAI")
def test_openai_generate_with_custom_params(mock_openai: Mock) -> None:
...
@patch("one.providers.openai.OpenAI")
def test_openai_generate_structured(mock_openai: Mock) -> None:
...
def test_anthropic_init_with_api_key(mock_anthropic: Mock) -> None:
    """Test initialization with explicit API key."""
...
@patch("one.providers.anthropic.Anthropic")
def test_anthropic_init_with_env_key(mock_anthropic: Mock) -> None:
    """Test initialization with environment variable."""
...
@patch("one.providers.anthropic.Anthropic")
def test_anthropic_generate(mock_anthropic: Mock) -> None:
    """Test text generation."""
    # Setup mock
    mock_client = MagicMock()
...
@patch("one.providers.anthropic.Anthropic")
def test_anthropic_generate_with_custom_params(mock_anthropic: Mock) -> None:
    """Test text generation with custom parameters."""
    # Setup mock
    mock_client = MagicMock()
    mock_anthropic.return_value = mock_client
...
@patch("one.providers.anthropic.Anthropic")
def test_anthropic_generate_structured(mock_anthropic: Mock) -> None:
    """Test structured output generation."""
    # Setup mock
    mock_client = MagicMock()
    mock_anthropic.return_value = mock_client
